...
var typed = new Typed(".typing", {
    strings:["","Web Designer","Web Developer","Full Stack Developer","Engineer","Life-Long Learner"], /* using a empty quotations else the first string will not be executed  */
    typeSpeed:100,
    BackSpeed:60,
    loop:true
});
