...
var typed = new Typed(".typing", {
    strings:["","Web Designer","Web Developer","Full Stack Java Developer","Engineer","Life-Long Learner"], /* using a empty quotations else the first string will not be executed  */
    typeSpeed:100,
    BackSpeed:60,
    loop:true
})
    ...
    else
{
  ...
  var composeUrl = "https://mail.google.com/mail/?view=cm&fs=1&to=" + encodeURIComponent(emailAddress) + "&su=" + encodeURIComponent(subject) + "&body=" + encodeURIComponent(mainbody);
